...
FClassRegistrationInfo Z_Registration_Info_UClass_AFpsGamePlayerController;
UClass* AFpsGamePlayerController::GetPrivateStaticClass()
{
	using TClass = AFpsGamePlayerController;
	if (!Z_Registration_Info_UClass_AFpsGamePlayerController.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("FpsGamePlayerController"),
			Z_Registration_Info_UClass_AFpsGamePlayerController.InnerSingleton,
			StaticRegisterNativesAFpsGamePlayerController,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AFpsGamePlayerController.InnerSingleton;
}
UClass* Z_Construct_UClass_AFpsGamePlayerController_NoRegister()
{
	return AFpsGamePlayerController::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFpsGamePlayerController_Statics::NewProp_DefaultMappingContexts_Inner = { "DefaultMappingContexts", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFpsGamePlayerController_Statics::NewProp_DefaultMappingContexts = { "DefaultMappingContexts", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFpsGamePlayerController, DefaultMappingContexts), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DefaultMappingContexts_MetaData), NewProp_DefaultMappingContexts_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFpsGamePlayerController_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFpsGamePlayerController_Statics::NewProp_DefaultMappingContexts_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFpsGamePlayerController_Statics::NewProp_DefaultMappingContexts,
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_FpsGame_Source_FpsGame_FpsGamePlayerController_h__Script_FpsGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFpsGamePlayerController, AFpsGamePlayerController::StaticClass, TEXT("AFpsGamePlayerController"), &Z_Registration_Info_UClass_AFpsGamePlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFpsGamePlayerController), 3190663125U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FpsGame_Source_FpsGame_FpsGamePlayerController_h__Script_FpsGame_3283260356(TEXT("/Script/FpsGame"),
	Z_CompiledInDeferFile_FID_FpsGame_Source_FpsGame_FpsGamePlayerController_h__Script_FpsGame_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FpsGame_Source_FpsGame_FpsGamePlayerController_h__Script_FpsGame_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
